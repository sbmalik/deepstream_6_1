...
import pyds
import ctypes
ctypes.cdll.LoadLibrary("/opt/nvidia/deepstream/deepstream-6.1/sources/dst_python_apps/models/yolov5/yolov5s/libYoloV5Decoder.so")
...
def main(args):
    ...
    pgie.set_property('config-file-path', "/opt/nvidia/deepstream/deepstream-6.1/sources/dst_python_apps/models/yolov5/yolov5s/config_yolov5.txt")
